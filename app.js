...
function registerUser(){
	...
	let validMail = checkValidMail(email);
	if(validPassword && validFullName && validMail){
		users.push({userName, psw,fullName, email, birthDate});
		if (confirm('Registration Succeed ! Do you want to start a game right now ?')) {
			// start game 
		  } else {
			// don't start game!
		  }
